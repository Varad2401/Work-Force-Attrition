...
class login_system:
    ...
    # Create Widgets
        ...
        self.bg1_icon=ImageTk.PhotoImage(file="D:/Ravina data/work force Attrition/m.jpg")

        self.bg_icon=ImageTk.PhotoImage(file="D:/Ravina data/work force Attrition/L.jpg")
        self.user_icon=ImageTk.PhotoImage(file="D:/Ravina data/work force Attrition/l1.png")
        self.pass_icon=ImageTk.PhotoImage(file="D:/Ravina data/work force Attrition/p1.jpg")
        
        bg_lbl=Label(self.root,image=self.bg1_icon).pack()
        
        title=Label(self.root, text="Login Here", font=("Times new roman", 30, "bold"), bg="black",fg="red",bd=5,relief=GROOVE)
        ...
        btn_login=Button(Login_frame,text="Login",command=self.login,width=15,font=("Times new roman", 14, "bold"),bg="brown",fg="black").grid(row=3,column=1,pady=10)
        btn_reg=Button(Login_frame,text="Create Account",command=self.registration,width=15,font=("Times new roman", 14, "bold"),bg="brown",fg="black").grid(row=3,column=0,pady=10)
