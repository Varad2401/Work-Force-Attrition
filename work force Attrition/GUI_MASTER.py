...
def SVM():
    ...
    # label_msg=tk.Label(root,text="Model training start...",font=('times',14),bg="green",fg="white")
    # label_msg.place(x=600,y=160)
    ...
    label5 = tk.Label(root,text ="Accracy : "+str(ACC)+"%\nModel saved as SVM_Prediction1.joblib",width=45,height=3,bg='khaki',fg='black',font=("Tempus Sanc ITC",14))
    label5.place(x=50,y=420)
    from joblib import dump
    dump (svcclassifier,"SVM_Prediction1.joblib")
    print("Model saved as SVM_Prediction1.joblib")
...
def RF():
    ...
    label5 = tk.Label(root,text ="Accracy : "+str(ACC)+"%\nModel saved as RF_Prediction1.joblib",width=45,height=3,bg='khaki',fg='black',font=("Tempus Sanc ITC",14))
    label5.place(x=50,y=420)
    from joblib import dump
    dump (svcclassifier,"RF_Prediction1.joblib")
    print("Model saved as RF_Prediction1.joblib")
...
def DT():
    ...
    label5 = tk.Label(root,text ="Accracy : "+str(ACC)+"%\nModel saved as DT_Prediction1.joblib",width=45,height=3,bg='khaki',fg='black',font=("Tempus Sanc ITC",14))
    label5.place(x=50,y=420)
    from joblib import dump
    dump (svcclassifier,"DT_Prediction1.joblib")
    print("Model saved as DT_Prediction1.joblib")
